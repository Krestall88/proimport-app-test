...
export default function AgentClientDetail({ client, canEdit }: AgentClientDetailProps) {
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6">
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="name" className="block mb-2 text-sm font-medium">Наименование клиента *</label>
              <input
                type="text"
                id="name"
                name="name"
