...
import { createClientAction } from './CreateClientForm';
  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      <div className="flex items-center mb-6">
        <Link href="/clients" className="text-sm flex items-center gap-2 hover:underline">
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-8">
        ...
        <form action={createClientAction} className="space-y-6">
          ...
          <div>
            <label htmlFor="address" className="block mb-2 text-sm font-medium">Юридический адрес *</label>
            <input 
              type="text" 
              id="address" 
              name="address" 
