-- Migration to create RPC function for inventory with customer order reservations
-- This function calculates actual available quantities by subtracting reserved items from customer orders
