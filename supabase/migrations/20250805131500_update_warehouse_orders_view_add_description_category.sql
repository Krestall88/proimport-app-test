-- 2025-08-05 13:15:00
-- Добавляет поля description и category в warehouse_orders_view для отображения наименования и категории товара на складе
...
SELECT
    ...
    p.description as description, -- новое поле
    p.category as category,       -- новое поле
    coi.quantity,
    p.unit,
    gri.batch_number,
    gri.expiry_date
